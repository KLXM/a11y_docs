...
$package = rex_addon::get('a11y_docs');
...
if ('screenreader' !== $subpage) {
	echo rex_view::title($package->i18n('title')); // $addon->i18n('title') ist eine Kurzform für rex_i18n::msg('demo_addon_title')
}
...
// Der aktuelle Subpage-Part ist bereits oben ermittelt.
