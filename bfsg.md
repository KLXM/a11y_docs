...
- **Bundesfachstelle Barrierefreiheit: Barrierefreie PDFs**: [Barrierefreie-PDF](https://www.bundesfachstelle-barrierefreiheit.de/DE/Fachwissen/Informationstechnik/Barrierefreie-PDF/barrierefreie-pdf_node) - Knappschaft Bahn See
...
📄 **[Umfassende Anleitung: Barrierefreie PDFs mit Microsoft Word erstellen](https://data.klxm.de/index.php/s/bFm4t66C8swfKjP)**

Diese detaillierte Schritt-für-Schritt-Anleitung zeigt Ihnen:
- Wie Sie Dokumente von Anfang an barrierefrei strukturieren
- Welche Formatierungen wichtig sind
- Wie Sie Bilder und Tabellen zugänglich machen
- Export-Einstellungen für barrierefreie PDFs
- Prüfung und Nachbearbeitung der fertigen PDF